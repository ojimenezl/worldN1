...
class ProceduralTerrain_Demo extends game.Game {
    ...
    _OnInitialize() {
        ...
        this._visibilityGrid = new visibility.VisibilityGrid(
            [new THREE.Vector3(-10000, 0, -10000), new THREE.Vector3(10000, 0, 10000)], [100, 100]);
        ...
        loader.load('scene.gltf', (gltf) => {
            ...
            this._entities['player'] = new PlayerEntity({ model: group, camera: this._graphics.Camera, game: this });
